...
public class JwtTokenProvider {
	...
	//Jwt토큰 생성 및 유효성 검증을 하는 클래스

	//Secret key 생성
	private String secretKey = "DevNamgyu";

	// 시간설정 : 1시간만 토큰 유효
	private long tokenVaildMilisecond = 1000L * 60 * 60 ;

	//UserDetailsService 선언
	...
	public String createToken (String userPk, List<String> roles) {
		...
		return Jwts.builder()
				...
				.setExpiration(new Date(now.getTime() + tokenVaildMilisecond)) //토큰 만료시간 설정
